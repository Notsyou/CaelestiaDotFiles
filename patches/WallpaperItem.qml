...
Item {
    ...
    readonly property bool isVideo: [".mp4", ".mkv", ".webm", ".mov", ".m4v"].includes("." + root.modelData.suffix.toLowerCase())
    ...
    StyledClippingRect {
        ...
        MaterialIcon {
            ...
            text: "image"
            visible: !thumbLoader.item || thumbLoader.item.status !== Image.Ready
        ...
        Loader {
            ...
            sourceComponent: CachingImage {
                path: root.isVideo ? (Quickshell.env("HOME") + "/.cache/caelestia/video-thumbs/" + root.modelData.relativePath + ".jpg") : root.modelData.path
